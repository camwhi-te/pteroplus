...
const light = css<Props>`
    ...
    &:disabled {
        ${tw`bg-neutral-200 border-neutral-200`};
    }
`;

const checkboxStyle = css<Props>`
    ${tw`bg-neutral-600 cursor-pointer appearance-none inline-block align-middle select-none flex-shrink-0 w-4 h-4 text-primary-400 border border-neutral-300 rounded-sm`};
    color-adjust: exact;
...
const inputStyle = css<Props>`
    ...
    ${tw`bg-neutral-700 border-neutral-500 hover:border-neutral-400 text-neutral-200 shadow-none focus:ring-0`};
